...
def main():
    ...
    with torch.no_grad():
        ...
        config = os.path.join(script_dir, 'wholebody_w48_384x384_adam_lr1e-3.yaml')
        ...
        config_2 = os.path.join(script_dir, 'wholebody_hrnet_w48_384x384.pth')
        checkpoint = torch.load(config_2, map_location="cuda:0")

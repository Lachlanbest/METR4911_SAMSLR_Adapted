...
def main():
    ...
    with torch.no_grad():
        ...
        input_path = '/home/Student/s4582342/data/train'
        paths = []
        names = []
        ...
        paths = paths[14000:21000]
        names = names[14000:21000]
        paths = paths[::-1]
        names = names[::-1]
        ...
        for i, path in enumerate(paths):
            # if i > 1:
            #     break
            output_npy = '/home/Student/s4582342/wholebody_train/{}.npy'.format(names[i])

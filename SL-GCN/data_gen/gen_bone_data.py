...
for dataset in datasets:
    for set in sets:
        print(dataset, set)
        data = np.load('/home/Student/s4582342/CVPR21Chal-SLR/SL-GCN/data/{}/{}_data_joint.npy'.format(dataset, set))
        N, C, T, V, M = data.shape
        fp_sp = open_memmap(
            '/home/Student/s4582342/CVPR21Chal-SLR/SL-GCN/data/{}/{}_data_bone.npy'.format(dataset, set),
            dtype='float32',
            mode='w+',
            shape=(N, 3, T, V, M))

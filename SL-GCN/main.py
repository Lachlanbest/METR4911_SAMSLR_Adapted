...
class Processor():
    ...
    def __init__(self, arg):
        ...
        arg.model_saved_name = "/home/Student/s4582342/save_models/" + arg.Experiment_name
        arg.work_dir = "/home/Student/s4582342/work_dir/" + arg.Experiment_name
        self.arg = arg
        self.save_arg()
        if arg.phase == 'train':
    ...
    def load_model(self):
        self.arg.device = 0
        output_device = self.arg.device  # Use GPU with device ID 0
    ...
    def train(self, epoch, save_model=False):
        ...
        for batch_idx, (data, label, index) in enumerate(process):
            ...
            # Debug statements to print the shapes of label and output tensors
            #print("Shape of label tensor:", label.shape)
            #print("Shape of output tensor:", output.shape)

            # Debug statements to print the shapes of label and output tensors
            #print("Shape of label tensor:", label.size())
            #print("Shape of output tensor:", output.size())
        ...
        with torch.no_grad():
            ...
            for ln in loader_name:
                ...
                if accuracy > self.best_acc:
                    ...
                    with open('/home/Student/s4582342/work_dir/' + arg.Experiment_name + '/eval_results/best_acc' + '.pkl'.format(
                ...
                with open('/home/Student/s4582342/work_dir/' + arg.Experiment_name + '/eval_results/epoch_' + str(epoch) + '_' + str(accuracy) + '.pkl'.format(
                        epoch, accuracy), 'wb') as f:
                    pickle.dump(score_dict, f)
